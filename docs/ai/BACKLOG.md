...
- [ ] **Randomize with Tonnetz chord awareness** — Current randomizer produces only acid-style patterns. Add a mode that uses Tonnetz chord data to generate house-style chord progressions, pad voicings, and melodic phrases that respect harmonic context
