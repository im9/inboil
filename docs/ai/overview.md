...
- 19 voice types: 11 drum (unified DrumMachine — Kick, Kick808, Snare, Clap, Hat, OpenHat, Cymbal, Tom, Rimshot, Cowbell, Shaker), 2 sample (Crash, Ride via SamplerVoice), 2 bass (TB-303, Analog), 2 lead (Moog with arpeggiator, 4-op FM with 8 algorithms — ADR 068), 1 wavetable synth (iDEATH — mono/poly via polyMode param), 1 user sampler
