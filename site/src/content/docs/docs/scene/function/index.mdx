...
Function nodes create musical material algorithmically instead of playing a stored pattern. Add one by right-clicking (or long-pressing) empty space in the Scene canvas and choosing an engine.
...
- [Decorators](/docs/scene/decorators/) — per-node modifiers (also apply to function nodes)
