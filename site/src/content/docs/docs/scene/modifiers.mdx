...
Add modifiers from the **tool palette** (circular buttons at the top of the scene) and click a pattern node to attach. Each modifier type has a distinctive icon: ♪↕ (transpose), ⟳ (repeat), metronome (tempo), ✦ (FX).
