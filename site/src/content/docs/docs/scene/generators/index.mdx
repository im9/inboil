...
| Engine | Behavior |
|--------|----------|
| **[Turing Machine](/docs/scene/generators/turing-machine/)** | Shift-register sequencer — generates pseudo-random sequences that evolve over time |
| **[Quantizer](/docs/scene/generators/quantizer/)** | Snaps incoming notes to a scale — most useful chained after a Turing Machine |
| **[Tonnetz](/docs/scene/generators/tonnetz/)** | Navigates harmonic relationships to generate chord progressions |
