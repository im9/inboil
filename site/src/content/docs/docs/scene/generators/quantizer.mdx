...
:::note[Harmony + Arp]
If a Tonnetz with arpeggio feeds mono notes into a Quantizer in Harmony mode, the Quantizer adds harmony voices to each arp note — turning single notes into chords. This can produce rich results, but may not always be the intended behavior.
:::
