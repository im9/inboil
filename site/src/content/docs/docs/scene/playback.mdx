...
3. **Apply function node modifiers** — transpose, tempo, repeat, and FX are applied during playback
...
Performance effects work during scene playback, layering on top of any function node modifiers in real-time.
...
- [Function Node Modifiers](/docs/scene/decorators/) — per-node modifiers
