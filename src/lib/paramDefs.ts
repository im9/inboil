...
const VOICE_PARAMS: Record<string, ParamDef[]> = {
  ...
  FM: [
    ...
    { key: 'op1Fb',      label: 'FB1',  group: 'fb',     tip: 'OP1 feedback',                    tipJa: 'OP1 フィードバック',          min: 0.0, max: 1.0, default: 0.15 },
    { key: 'op2Fb',      label: 'FB2',  group: 'fb',     tip: 'OP2 feedback',                    tipJa: 'OP2 フィードバック',          min: 0.0, max: 1.0, default: 0.0 },
    { key: 'op3Fb',      label: 'FB3',  group: 'fb',     tip: 'OP3 feedback',                    tipJa: 'OP3 フィードバック',          min: 0.0, max: 1.0, default: 0.0 },
    { key: 'op4Fb',      label: 'FB4',  group: 'fb',     tip: 'OP4 feedback',                    tipJa: 'OP4 フィードバック',          min: 0.0, max: 1.0, default: 0.0 },
    { key: 'op1Ratio',   label: 'R1',   group: 'ratio',  tip: 'OP1 frequency ratio',             tipJa: 'OP1 周波数比',                min: 0.5, max: 16.0, default: 1.0 },
    { key: 'op2Ratio',   label: 'R2',   group: 'ratio',  tip: 'OP2 frequency ratio',             tipJa: 'OP2 周波数比',                min: 0.5, max: 16.0, default: 2.0 },
    { key: 'op3Ratio',   label: 'R3',   group: 'ratio',  tip: 'OP3 frequency ratio',             tipJa: 'OP3 周波数比',                min: 0.5, max: 16.0, default: 3.0 },
    { key: 'op4Ratio',   label: 'R4',   group: 'ratio',  tip: 'OP4 frequency ratio',             tipJa: 'OP4 周波数比',                min: 0.5, max: 16.0, default: 4.0 },
    { key: 'op1Detune',  label: 'DT1',  group: 'detune', tip: 'OP1 detune (cents)',               tipJa: 'OP1 デチューン（セント）',    min: -1200, max: 1200, default: 0 },
    { key: 'op2Detune',  label: 'DT2',  group: 'detune', tip: 'OP2 detune (cents)',               tipJa: 'OP2 デチューン（セント）',    min: -1200, max: 1200, default: 0 },
    { key: 'op3Detune',  label: 'DT3',  group: 'detune', tip: 'OP3 detune (cents)',               tipJa: 'OP3 デチューン（セント）',    min: -1200, max: 1200, default: 0 },
    { key: 'op4Detune',  label: 'DT4',  group: 'detune', tip: 'OP4 detune (cents)',               tipJa: 'OP4 デチューン（セント）',    min: -1200, max: 1200, default: 0 },
    { key: 'op1Level',   label: 'L1',   group: 'level',  tip: 'OP1 output level',                tipJa: 'OP1 レベル',                  min: 0.0, max: 1.0, default: 1.0 },
    { key: 'op2Level',   label: 'L2',   group: 'level',  tip: 'OP2 output level',                tipJa: 'OP2 レベル',                  min: 0.0, max: 1.0, default: 0.7 },
    { key: 'op3Level',   label: 'L3',   group: 'level',  tip: 'OP3 output level',                tipJa: 'OP3 レベル',                  min: 0.0, max: 1.0, default: 0.5 },
    { key: 'op4Level',   label: 'L4',   group: 'level',  tip: 'OP4 output level',                tipJa: 'OP4 レベル',                  min: 0.0, max: 1.0, default: 0.3 },
    { key: 'op1Decay',   label: 'D1',   group: 'decay',  tip: 'OP1 decay time',                  tipJa: 'OP1 ディケイ',                min: 0.01, max: 4.0, default: 0.30 },
    { key: 'op2Decay',   label: 'D2',   group: 'decay',  tip: 'OP2 decay time',                  tipJa: 'OP2 ディケイ',                min: 0.01, max: 4.0, default: 0.20 },
    { key: 'op3Decay',   label: 'D3',   group: 'decay',  tip: 'OP3 decay time',                  tipJa: 'OP3 ディケイ',                min: 0.01, max: 4.0, default: 0.10 },
    { key: 'op4Decay',   label: 'D4',   group: 'decay',  tip: 'OP4 decay time',                  tipJa: 'OP4 ディケイ',                min: 0.01, max: 4.0, default: 0.08 },
    { key: 'op1Attack',  label: 'ATK',  group: 'amp',    tip: 'Carrier attack',                  tipJa: 'キャリアアタック',              min: 0.001, max: 2.0, default: 0.003 },
    { key: 'op1Release', label: 'REL',  group: 'amp',    tip: 'Carrier release',                 tipJa: 'キャリアリリース',              min: 0.01, max: 4.0, default: 0.40 },
    { key: 'lfoRate',    label: 'LRAT', group: 'lfo',    tip: 'LFO rate (Hz)',                   tipJa: 'LFO レート',                  min: 0.1, max: 20.0, default: 2.0 },
    { key: 'lfoDepth',   label: 'LDEP', group: 'lfo',    tip: 'LFO depth',                       tipJa: 'LFO 深さ',                    min: 0.0, max: 1.0, default: 0.0 },
    { key: 'lfoWave',    label: 'LWAV', group: 'lfo',    tip: 'LFO wave: SIN/TRI/SAW/SQR/S&H',  tipJa: 'LFO 波形',                    min: 0, max: 4, step: 1, default: 0 },
  ...
  WT: [
    ...
    { key: 'driveType',    label: 'DTYP',  group: 'filter', tip: 'Drive: SOFT → HARD → FOLD → CRUSH', tipJa: 'ドライブ: SOFT → HARD → FOLD → CRUSH', min: 0, max: 3, step: 1, default: 0 },
  ...
  FMDrum: [
    { key: 'machine',  label: 'MACH',  group: 'osc',  tip: 'Machine: KICK → SNARE → METAL → PERC → TONE → CHORD', tipJa: 'マシン: KICK → SNARE → METAL → PERC → TONE → CHORD', min: 0, max: 5, step: 1, default: 0 },
    { key: 'color',    label: 'COLR',  group: 'osc',  tip: 'Timbral brightness (mod ratio)',    tipJa: '音色の明るさ（モジュレータ比率）',  min: 0.0, max: 1.0, default: 0.5  },
    { key: 'shape',    label: 'SHPE',  group: 'osc',  tip: 'FM depth / mod index',              tipJa: 'FM深さ / モジュレーション指数',     min: 0.0, max: 1.0, default: 0.5  },
    { key: 'sweep',    label: 'SWEP',  group: 'env',  tip: 'Pitch envelope depth',              tipJa: 'ピッチエンベロープ深さ',            min: 0.0, max: 1.0, default: 0.5  },
    { key: 'contour',  label: 'CNTR',  group: 'env',  tip: 'Pitch envelope time',               tipJa: 'ピッチエンベロープ時間',            min: 0.0, max: 1.0, default: 0.3  },
    { key: 'punch',    label: 'PNCH',  group: 'amp',  tip: 'Attack transient click',            tipJa: 'アタックトランジェント',            min: 0.0, max: 1.0, default: 0.5  },
    { key: 'decay',    label: 'DCY',   group: 'amp',  tip: 'Amplitude decay time',              tipJa: '音量ディケイ',                      min: 0.01, max: 2.0, default: 0.3 },
    { key: 'tone',     label: 'TONE',  group: 'amp',  tip: 'Output filter brightness',          tipJa: '出力フィルター明るさ',              min: 0.0, max: 1.0, default: 0.5  },
  ],
  Sampler: [
...
const DISPLAY_LABELS: Record<string, string[]> = {
  ...
  machine: ['KICK', 'SNR', 'METL', 'PERC', 'TONE', 'CHRD'],
  reverse: ['OFF', 'ON'],
