...
const FM_PRESETS: SynthPreset[] = [
  { name: 'Bell', voiceId: 'FM', params: {
    op2Ratio: 3.0, fbAmt: 0.3, op2Index: 5.0, carrierIndex: 2.5, decay: 0.6,
  }},
  { name: 'Pluck', voiceId: 'FM', params: {
    op2Ratio: 2.0, fbAmt: 0.4, op2Index: 6.0, carrierIndex: 4.0, decay: 0.18,
  }},
  { name: 'Metallic', voiceId: 'FM', params: {
    op2Ratio: 3.5, fbAmt: 0.7, op2Index: 7.0, carrierIndex: 5.0, decay: 0.35,
  }},
  { name: 'Soft', voiceId: 'FM', params: {
    op2Ratio: 1.0, fbAmt: 0.2, op2Index: 2.5, carrierIndex: 2.0, decay: 0.45,
  }},
]
